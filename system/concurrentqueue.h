...
namespace moodycamel { namespace details {
  ...
  static inline thread_id_t thd_id() { return rl::thread_index(); }
} }
...
namespace moodycamel { namespace details {
  ...
  static inline thread_id_t thd_id() { return static_cast<thread_id_t>(::GetCurrentThreadId()); }
} }
#else
...
namespace moodycamel { namespace details {
  ...
  static const thread_id_t invalid_thread_id2 = 1;    // Member access off a null pointer are also generally invalid. Plus it's not aligned.
  static inline thread_id_t thd_id() { static MOODYCAMEL_THREADLOCAL int x; return reinterpret_cast<thread_id_t>(&x); }
} }
#endif
